...
Code can be found in code cell No. 22, 23 in P5.ipynb
Final result video can be found in ![final_video][/P5_solution_v6.mp4]

It can also be view on Youtube: https://youtu.be/VpdrtnY0if0
